...
export function AuthLayout({ children, type }: AuthLayoutProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-linear-to-br from-[#183495] via-[#1a3a9d] to-[#0E2A7D] relative overflow-hidden">
        ...
        <>
          ...
          <div className="flex-1 p-6 sm:p-8 lg:p-12 flex flex-col justify-center items-center relative z-10">
            <div className="text-center">
              ...
              <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-lg h-72 sm:h-96 lg:h-120 mx-auto">
