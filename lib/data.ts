...
export const conversions = [
  {
    id: 1,
    leadId: 5,
    leadName: "Rudi Hartono",
    amount: 50000000,
    duration: "12 months",
    rate: 5.5,
    conversionDate: "2025-10-28",
    salesPerson: "Andi Wijaya",
    campaignType: "Outbound Call",
  },
  {
    id: 2,
    leadId: 6,
    leadName: "Maya Kusuma",
    amount: 25000000,
    duration: "6 months",
    rate: 5.0,
    conversionDate: "2025-10-25",
    salesPerson: "Sari Dewi",
    campaignType: "Email Campaign",
  },
  {
    id: 3,
    leadId: 9,
    leadName: "Bambang Susilo",
    amount: 75000000,
    duration: "24 months",
    rate: 6.0,
  ...
  },
  {
    id: 4,
    leadId: 10,
    leadName: "Lestari Indah",
    amount: 30000000,
    duration: "12 months",
    rate: 5.5,
    conversionDate: "2025-10-20",
    salesPerson: "Budi Santoso",
    campaignType: "Branch Visit",
  },
  {
    id: 5,
    leadId: 11,
    leadName: "Dimas Prasetyo",
    amount: 45000000,
    duration: "18 months",
    rate: 5.75,
    conversionDate: "2025-10-18",
    salesPerson: "Sari Dewi",
    campaignType: "Outbound Call",
  },
];
